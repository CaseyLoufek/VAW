...
public class ModelBloodLust extends ModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity){
        ...
        this.RightLeg1.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.4F * f1 / f;
        this.LeftLeg1.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1 / f;
        ...
        this.RightWing1.rotateAngleY += MathHelper.cos(f * 0.6662F) * 1.4F * f1 + 0.1F;
        this.LeftWing1.rotateAngleY -= MathHelper.cos(f * 0.6662F) * 1.4F * f1 + 0.1F;
    }
